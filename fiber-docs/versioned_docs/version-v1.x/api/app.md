...
This method creates a new **App** named instance. You can pass optional [settings ](#settings)when creating a new instance
...
:::caution
**Listener** does not support the [**Prefork**](#settings) feature.
:::
