...
| ReadTimeout               | `time.Duration` | Jumlah waktu yang diizinkan untuk membaca permintaan lengkap termasuk isi. Batas waktu default tidak terbatas.                                                                                                                                                         | `nil`             |
| WriteTimeout              | `time.Duration` | Durasi maksimum sebelum waktu habis menulis respon. Batas waktu default tidak terbatas.                                                                                                                                                                                | `nil`             |
| IdleTimeout               | `time.Duration` | Jumlah waktu maksimum untuk menunggu `request` berikutnya ketika `keep-live` diaktifkan. Jika IdleTimeout adalah nol, nilai ReadTimeout digunakan.                                                                                                                 | `nil`             |
