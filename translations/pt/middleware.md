...
| [**basicauth**](https://github.com/gofiber/basicauth)                                                                | O middleware de autenticação básica fornece uma autenticação básica HTTP. It calls the next handler for valid credentials and 401 Unauthorized for missing or invalid credentials. | -                        |
...
| [**limiter**](https://github.com/gofiber/limiter)                                                                    | Rate-limiting middleware for Fiber. Use para limitar solicitações repetidas a APIs públicas e/ou endpoints como redefinição de senha.                                              | -                        |
