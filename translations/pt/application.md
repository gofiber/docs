...
Este método cria uma nova **App** instância com nome.  
Você pode passar as configurações [opcionais ](application.md#settings)ao criar uma nova instância
...
Você pode passar as configurações do aplicativo ao chamar `novos`.
