...
| \*\*\*\*[**favicon**](https://github.com/gofiber/fiber/blob/master/middleware/favicon.md)\*\*\*\*    | Ignora los registros, logs, de favicon o lo sirve desde memoria si se provee una ruta de sistema de ficheros.                                                     | `middleware.Favicon()`   |
| \*\*\*\*[**helmet**](https://github.com/gofiber/helmet)\*\*\*\*                                      | Añade seguridad a tus aplicaciones ajustando varias cabeceras HTTP.                                                                                               | -                        |
| [**jwt**](https://github.com/gofiber/jwt)                                                                            | Middleware de autenticación por JSON Web Token (JWT).                                                                                                             | -                        |
| [**keyauth**](https://github.com/gofiber/keyauth)                                                                    | Proporciona una autenticación básica por llave.                                                                                                                   | -                        |
...
| [**pprof**](https://github.com/gofiber/pprof)                                                                        | Agradecimiento especial a Matthew Lee \(@mthli\).                                                                                                               | -                        |
| \*\*\*\*[**recover**](https://github.com/gofiber/fiber/blob/master/middleware/recover.md)\*\*\*\*    | Permite la recuperación desde "panics" en cualquier punto de la pila y deriva el control al [manejador de errores](error-handling.md) centralizado.               | `middleware.Recover()`   |
