...
| TemplateEngine            | `func(raw string, bind interface{}) (string, error)` | Vous pouvez spécifier une fonction de modèle personnalisée afin de restituer le contenu dans différentes langues de modèle. See our [**Template Middleware**](middleware.md#template) _\*\*_for presets.                                                              | `nil`             |
