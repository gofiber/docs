...
إذا كنت ترغب في أن يكون لديك تحكم أكثر قليلاً فيما يتعلق بإعدادات تقديم الملفات الثابتة. You could use the `fiber.Static` struct to enable specific settings.
